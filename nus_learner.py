...
filenames = [r'../Concept/Labels_animal.txt', r'../Concept/Labels_buildings.txt', 
			r'../Concept/Labels_clouds.txt', r'../Concept/Labels_grass.txt', 
			r'../Concept/Labels_lake.txt', r'../Concept/Labels_person.txt', 
			r'../Concept/Labels_plants.txt', r'../Concept/Labels_sky.txt',
			r'../Concept/Labels_water.txt', r'../Concept/Labels_window.txt']
